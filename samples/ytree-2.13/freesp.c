...
#include <dos.h>
#else
#if defined( SVR4 ) || defined( OSF1 ) || defined( sun56 ) || defined( __NetBSD__ ) || defined(__HAIKU__)
...
#else
#if defined( SVR4 ) || defined( OSF1 ) || defined( __NetBSD__ ) || defined(__HAIKU__)
